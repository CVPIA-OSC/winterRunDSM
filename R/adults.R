...
adult_stray <- function(wild, natal_flow, south_delta_watershed, cross_channel_gates_closed,
                        ...
                        .cross_channel_gate_closed = -0.174, .prop_bay_trans = 2.09, 
  ...
  boot::inv.logit(
      ...
      .cross_channel_gate_closed * south_delta_watershed * cross_channel_gates_closed +
...
surv_adult_enroute <- function(migratory_temp, bypass_overtopped, adult_harvest,
  ...
  pmax(boot::inv.logit(..surv_adult_enroute_int + .migratory_temp * migratory_temp + .bypass_overtopped * bypass_overtopped) - adult_harvest, 0)
