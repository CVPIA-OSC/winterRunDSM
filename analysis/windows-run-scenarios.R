...
run_scenario <- function(scenario) {
  s <- winter_run_model(mode = 'seed', stochastic = TRUE)
  output <- winter_run_model(scenario = scenario, mode = 'simulate',
...
clusterExport(cl, list('run_scenario', 'winter_run_model'))
